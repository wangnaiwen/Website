...
<html>
  <head>
    ...
    <title>My JSP 'StudentChooseCourse.jsp' starting page</title>
	...
	<div class="row-fluid">
		<div class="span12">
			<div class="navbar">
				<div class="navbar-inner">
					<div class="container-fluid">
						...
						<form action="servlet/StudentChooseCourse" method="get">
						...
						List<Course> list = cc.doSelectBySID(sid);
						...
						<tr>
							...
							<td><%=teacher %></td>
							<td>
								<input type="checkbox" name="chooseCourse" value="<%=cid %>">选课
							</td>
						</tr>
						<%
					}
			...
			%> 
				...
				<%
					if (curPage != 1){
						out.println("<a href=studentChooseCourse.jsp?curPage="
								+ (curPage - 1)+">上一页</a>");
					}
					//显示超链接
					for (int j = 1; j <= pageCount; j++) {
						out.println("<a href=studentChooseCourse.jsp?curPage=" + j + ">["
								+ j + "]</a>");
					}
					//下一页

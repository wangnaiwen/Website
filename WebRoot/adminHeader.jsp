					...
					<div class="container-fluid">
						<div class="nav-collapse collapse navbar-responsive-collapse" align="center">
							<ul class="nav" >
								...
								<li>
									<a href="http://desktop-kg8cd68:8081/1300310118/sevenAdmin.jsp">添加课程</a>
								</li>
								<li>
									<a href="http://desktop-kg8cd68:8081/1300310118/eightAdmin.jsp ">管理课程</a>
								</li>
								<li>
									<a href="http://desktop-kg8cd68:8081/1300310118/nineAdmin.jsp">管理论坛</a>
								</li>
								<li>
									<a href="http://desktop-kg8cd68:8081/1300310118/tenAdmin.jsp">修改密码</a>
								</li>
								<li>

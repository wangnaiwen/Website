...
public class TeaDetailOfQuestion extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if(content.isEmpty()){
			...
			TeaCRUD teaCRUD = new TeaCRUD();
			Teacher teacher = teaCRUD.doSelect(tid);
			...
			//在这里跳转到当前页面，刷新
			request.getRequestDispatcher("/teaDetailOfQuestion.jsp?cid="+cid+"&qno="+qno).forward(request, response);
		}

			...
			<div class="navbar">
				<div class="navbar-inner">
					<div class="container-fluid">
						...
						<form action="servlet/Submit" method="post" enctype="multipart/form-data">
							<%
							...
							*作业的描述: <br><br>
							<textarea cols="200" name="content" style="height: 300px; width: 800px;max-width:800px;max-height:300px"; >
							</textarea><br><br>

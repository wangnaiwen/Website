...
<html>
  <head>
    ...
    <title>My JSP 'studentJob.jsp' starting page</title>
	...
	<div class="row-fluid">
		<div class="span12">
				...
				<div class="navbar-inner">
					<div class="container-fluid">
						...
						<tr>
							<td><%=cname %></td>
							<td>
								<a href="http://desktop-kg8cd68:8081/1300310118/jobOfCourse.jsp?cid=<%=cid %>">查看作业</a>
							</td>
						</tr>
						<%
					}
			...
			%> 
				...
				<%
					if (curPage != 1){
						out.println("<a href=studentJob.jsp?curPage="
								+ (curPage - 1)+">上一页</a>");
					}
					//显示超链接
					for (int j = 1; j <= pageCount; j++) {
						out.println("<a href=studentJob.jsp?curPage=" + j + ">["
								+ j + "]</a>");
					}
					//下一页

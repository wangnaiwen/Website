...
public class TeacherDAO extends BaseHibernateDAO {
	...
	public Teacher findById(java.lang.String id) {
		...
		try {
			Teacher instance = (Teacher) getSession().get("entity.Teacher", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Teacher instance) {
		...
		try {
			List results = getSession().createCriteria("entity.Teacher")
	...
	public List findByAbstracts(Object abstracts) {

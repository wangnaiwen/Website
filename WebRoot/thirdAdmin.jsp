...
<html>
  <head>
    ...
    <title>My JSP 'thirdAdmin.jsp' starting page</title>
		...
		<div class="span12">
			<div class="navbar">
				<div class="navbar-inner">
					...
					<form action="servlet/ThirdAdminServlet" method="get">
					<br>
				...
				for(int i = z; i < size;i++){
					if(i < k){
						...
						<tr>
							...
							<td><%=type%></td>
							<td>
								<a href="http://desktop-kg8cd68:8081/1300310118/modifyStudentInfo.jsp?sid=<%=sid %>">修改信息</a>
							</td>
							<td>
			...
			%> 
				...
				<%
					if (curPage != 1){
						out.println("<a href=thirdAdmin.jsp?curPage="
								+ (curPage - 1)+">上一页</a>");
					}
					//显示超链接
					for (int j = 1; j <= pageCount; j++) {
						out.println("<a href=thirdAdmin.jsp?curPage=" + j + ">["
								+ j + "]</a>");
					}
					//下一页
				...
				%>
				<div>
						<input type="submit" name="deleteSel" value="删除选中的学生">
						<input type="submit" name="deleteAll" value="删除全部学生">

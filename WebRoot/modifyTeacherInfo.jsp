...
<html>
  <head>
    ...
    <title>My JSP 'modifyTeacherInfo.jsp' starting page</title>
			...
			<div class="navbar">
				<div class="navbar-inner">
					<div class="container-fluid">
						...
						<form action="servlet/ModifyTeacherInfo">
							<%
    							...
    							String passwd = tea.getPassword();
    							
    							String birthday = tea.getBirthday();
    							
    							String grade = tea.getGrade();
    							String abstracts = tea.getAbstracts();
    							
    							String phoneNum = tea.getPhoneNumber();
    							String qq = tea.getQq();
    							String wechat = tea.getWechat();
   							 ...
   							 职称：<input type="text" name="grade" value="<%=grade %>"><br>
   							 简 介：<input type="text" name="abstracts" value="<%=abstracts %>"><br>

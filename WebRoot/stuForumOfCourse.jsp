...
<html>
  <head>
    ...
    <title>My JSP 'forumOfCourse.jsp' starting page</title>
						...
						int k = pageSize*curPage;
   						...
   						for(int i = z; i < size; i++){
   							...
   							<tr>
   								...
   								<td><%=time %></td>
   								<td>
   									<a href="http://desktop-kg8cd68:8081/1300310118/detailOfQuestion.jsp?cid=<%=cid %>&qno=<%=qno %>">查看回复</a>
   								</td>
   							</tr>
   							<% 
   							}

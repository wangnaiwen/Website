...
<html>
  <head>
    ...
    <title>My JSP 'perfectInfo.jsp' starting page</title>
			...
			<div class="navbar">
				<div class="navbar-inner">
					<div class="container-fluid">
						...
						<form action="servlet/TeacherPerfectInfo" method="get"><br>
							
							<%
    							String id = Who.getTeacher();
    							Teacher teacher = new Teacher();
    							TeaCRUD tc = new TeaCRUD();
    							teacher = tc.doSelect(id);
    							
    							String name = teacher.getName(); 	
    							String passwd = teacher.getPassword();						
    							String birthday = teacher.getBirthday();
    							String grade = teacher.getGrade();
    							String abstracts = teacher.getAbstracts();
   							...
   							<%
   							 ...
   							 职 称：<input type="text" name="grade" value="<%=abstracts %>"><br>
